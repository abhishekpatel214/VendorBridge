          ...
          action={
            <div className="flex items-center space-x-3">
              ...
              <Button variant="outline" onClick={() => {}}>
                {/* Note: in a real app this would trigger window.print() but it's a server component.
                    We will implement a client-side print button inside a tiny component, or just use CSS. */}
      ...
      <div className="bg-white p-8 border rounded-lg shadow-sm print:shadow-none print:border-none print:p-0" id="print-area">
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-slate-500 mt-1">Purchase Order</p>
          </div>
          <div className="text-right">
            <h2 className="text-xl font-bold text-slate-800">{po.po_number}</h2>
            <p className="text-slate-500 mt-1">Date: {formatDate(po.created_at)}</p>
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div>
            <h3 className="font-bold text-slate-800 mb-2 border-b pb-1">Vendor Details</h3>
        ...
        {po.quotation_remarks && (
          <div className="mt-8 pt-6 border-t">
            <h3 className="font-bold text-slate-800 mb-2">Terms & Conditions / Remarks</h3>
